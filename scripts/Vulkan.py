...
JADE_VULKAN_VERSION = "1.4.335.0"
VULKAN_SDK_EXE_PATH = "Jade/vendor/VulkanSDK/VulkanSDK.exe"
...
def CheckVulkanSDK():
    ...
    elif (JADE_VULKAN_VERSION not in VULKAN_SDK):
        print(f"Located Vulkan SDK at {VULKAN_SDK}")
        print(f"You don't have the correct Vulkan SDK version! (Jade requires {JADE_VULKAN_VERSION})")
        InstallVulkanPrompt()
        return False
